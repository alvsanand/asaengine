...
public class Matrix3 implements Serializable {	
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4575384152381317380L;
	...
	public float det() {
		return vals[0] * vals[4] * vals[8] + vals[3] * vals[7] * vals[2] + vals[6] * vals[1] * vals[5] - vals[0] * vals[7] * vals[5] - vals[3]
				* vals[1] * vals[8] - vals[6] * vals[4] * vals[2];
	}
